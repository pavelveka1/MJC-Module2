...
public class TagDAOImpl implements TagDAO {
    ...
    private static final String GET_TAG_BY_ID = "select * from tags where id=?;";
     ...
     */
    @Override
    public Tag create(Tag tag) throws DuplicateKeyException {
        ...
        return read(Objects.requireNonNull(keyHolder.getKey()).longValue());
    }
